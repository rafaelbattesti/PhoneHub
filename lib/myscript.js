...
/**
 * Builds a cart and the checkout list of products
 * @param wrapperId
 * @param listId
 * @param buttonIdCancel
 * @param buttonIdOk
 */
...
function drawReport() {
    var canvas = $("#admincanvas").get(0);
    var context = canvas.getContext("2d");

    context.fillRect(0,0, 100 , 90);
    context.fillStyle = 'red';
    context.fillRect(50,50, 100 , 90);
    context.strokeStyle = 'green';
    context.strokeRect(150,150, 100 , 90);
}
