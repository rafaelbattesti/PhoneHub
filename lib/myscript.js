...
/**
 * Function will add an item to the cart
 * @param object
 */
function addToCart(product) {
    ...
    if (localStorage.getItem("cart") == null) {
        ...
        array = getLocalStorage("cart");
        array.push(product);
    }
    setLocalStorage("cart", array);
}

/**
 * Updates the products localstorage
 * @param products
 * @param productId
 */
function updateProducts(products, productId) {
